/*
  ...
  - Made the column `classId` on table `attendances` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_attendances" ("classId", "createdAt", "date", "id", "status", "studentId", "updatedAt") SELECT "classId", "createdAt", "date", "id", "status", "studentId", "updatedAt" FROM "attendances";
