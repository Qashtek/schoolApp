...
/**
 * DELETE /api/sessions/[sessionId]/terms/[termId]
 * Delete a term from a session
 */
export async function DELETE(
  ...
  try {
    ...
    const deletedTerm = await sessionService.deleteTerm(sessionId, termId);

    return NextResponse.json(deletedTerm);
  } catch (error) {
